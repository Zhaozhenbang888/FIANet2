...
def normalize_dataset_name(dataset_name):
    normalized = dataset_name.lower().strip().replace('_', '-').replace(' ', '')
    alias_map = {
        'refsegrs': 'refsegrs',
        'rrsisd': 'rrsisd',
        'nwpu': 'nwpu-refer',
        'nwpu-refer': 'nwpu-refer',
        'nwpurefer': 'nwpu-refer',
        'rsibench': 'rsibench_dataset',
        'rsibench-dataset': 'rsibench_dataset',
        'rsibench_dataset': 'rsibench_dataset',
    }
...
def get_dataset(image_set, transform, args):
    ...
    elif dataset_name == "nwpu-refer":
        from data.nwpu_refer_bert import ReferDataset
    elif dataset_name == "rsibench_dataset":
        from data.rsibench_dataset_refer_bert import ReferDataset
    else:
        raise ValueError(f'Unsupported dataset: {dataset_name}')
